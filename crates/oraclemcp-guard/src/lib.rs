...
pub use classifier::{
    ...
    builtin_only_virtual_column_expression, function_free_virtual_column_expression,
    hard_parse_user_calls, named_bind_placeholders, semantic_read_plan, semantic_read_plan_checked,
    stage_a,
};
