...
static DOCS: &[ConfigFieldDoc] = &[
    ...
    doc!("profiles.require_hard_parse_evidence", "bool", "false", true, false, "2", "Refuse EXPLAIN and decisive query-cost admission when hard-parse callback or PLAN_TABLE evidence is unreadable; default emits a verification observation and a separate audit record, and doctor warns."),
