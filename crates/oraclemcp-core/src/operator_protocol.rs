...
pub const OPERATOR_ROUTE_SPECS: &[OperatorRouteSpec] = &[
    ...
    OperatorRouteSpec {
        method: "GET",
        path: "/operator/v1/edition-proposals",
        schema: "editionProposalListResponse",
        sse: false,
        mcp_tool: None,
        browser_post: false,
    },
    OperatorRouteSpec {
        method: "POST",
        path: "/operator/v1/edition-proposals/draft",
        schema: "editionProposalDraftResponse",
        sse: false,
        mcp_tool: None,
        browser_post: true,
    },
    OperatorRouteSpec {
        method: "POST",
        path: "/operator/v1/edition-proposals/transition",
        schema: "editionProposalTransitionResponse",
        sse: false,
        mcp_tool: None,
        browser_post: true,
    },
    OperatorRouteSpec {
        method: "POST",
        path: "/operator/v1/edition-proposals/merge",
        schema: "editionProposalMergeResponse",
        sse: false,
        mcp_tool: Some("oracle_execute (ADMIN default-edition flip)"),
        browser_post: true,
    },
    OperatorRouteSpec {
        method: "POST",
        path: "/operator/v1/edition-proposals/rollback",
        schema: "editionProposalRollbackResponse",
        sse: false,
        mcp_tool: Some("oracle_execute (ADMIN default-edition flip)"),
        browser_post: true,
    },
...
pub fn operator_schema_bundle() -> Value {
    json!({
        ...
        "$defs": {
            ...
            "editionProposalListResponse": { "$ref": "#/$defs/versionedResponse" },
            "editionProposalDraftResponse": { "$ref": "#/$defs/versionedResponse" },
            "editionProposalTransitionResponse": { "$ref": "#/$defs/versionedResponse" },
            "editionProposalMergeResponse": { "$ref": "#/$defs/versionedResponse" },
            "editionProposalRollbackResponse": { "$ref": "#/$defs/versionedResponse" },
