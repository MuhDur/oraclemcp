...
// C2 orientation + fleet-orientation tool family (C6 de-monolith). Extracted
// isomorphically: `use orient::*;` restores the exact effective visibility these
...
mod read_executor;
pub use read_executor::{AdmittedRead, ServerSql};
use read_executor::{
    GeneratedReadAuditCtx, GuardedGeneratedReadConn, GuardedReadExecutor, ReadExecutionPlan,
    ReadOnlyBackstop, ReadUncertaintyConn, ensure_read_only_backstop_bounded,
};
