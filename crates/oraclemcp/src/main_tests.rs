...
#[path = "main_tests_issue51.rs"]
mod issue51;

/// Release manifest case `rel012_i51_second_instance` binds this exact test
/// name (`oraclemcp::tests::second_serve_instance_reports_audit_lock_issue_51`);
/// the body lives with the other #51 tests in `main_tests_issue51.rs`.
#[test]
fn second_serve_instance_reports_audit_lock_issue_51() {
    issue51::second_serve_instance_reports_audit_lock();
}
