...
fn readme_leads_with_hosted_install_one_liner_service_and_dashboard() {
    ...
    assert_eq!(
        first_shell_command,
        r#"curl -fsSL "https://raw.githubusercontent.com/MuhDur/oraclemcp/main/install.sh?$(date +%s)" | bash -s -- --version 0.6.3"#,
    ...
    for needle in [
        ...
        "bash -s -- --dry-run --version 0.6.3",
        "bash -s -- --version 0.6.3",
