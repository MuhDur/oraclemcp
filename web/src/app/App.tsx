...
import { OperatorOutcomeNotice, operatorOutcomeTone, ReviewsPage } from "./reviews-page";
...
export { authoritativeServerMode };
export {
  SourceHistoryPanel,
...
function ReviewsRoutePage(): React.ReactElement {
  const { id: selectedId = "" } = useSearch({ from: reviewsRoute.id });
  const navigate = useNavigate({ from: reviewsRoute.id });
  const onSelectedIdChange = React.useCallback(
    (next: string) => {
      void navigate({ search: { id: next || undefined }, replace: true });
    },
    [navigate]
  );
  return <ReviewsPage selectedId={selectedId} onSelectedIdChange={onSelectedIdChange} />;
}
      ...
      <div className="space-y-4">
        ...
        {dataError ? (
          <QueryErrorNotice
            ...
            retryingLabel="Retrying dashboard data"
            retrying={health.isFetching || metrics.isFetching || activeLanes.isFetching}
      ...
      <div className="space-y-4">
        ...
        {activeLanes.error instanceof Error ? (
          <QueryErrorNotice
            ...
            retryingLabel="Retrying sessions"
            retrying={activeLanes.isFetching}
        ...
        {metrics.error instanceof Error ? (
          <QueryErrorNotice
            ...
            retryingLabel="Retrying metrics"
        ...
        <div className="space-y-4">
          ...
          {error ? (
            <QueryErrorNotice
              ...
              retrying={metrics.isFetching || activeLanes.isFetching}
    ...
    <section aria-label="connection profiles" className="space-y-3">
      ...
      {health.error instanceof Error ? (
        <QueryErrorNotice
          ...
          retryingLabel="Retrying reachability"
      ...
      <div className="space-y-4">
        ...
        {config.error instanceof Error ? (
          <QueryErrorNotice
            ...
            retryingLabel="Retrying configuration"
            retrying={config.isFetching}
            onRetry={() => void config.refetch()}
          />
        ) : null}
        {session.error instanceof Error ? (
          <QueryErrorNotice
            ...
            retryingLabel="Retrying pairing state"
      ...
      <div className="space-y-4">
        {clients.error instanceof Error ? (
          <QueryErrorNotice
            ...
            retryingLabel="Retrying clients"
