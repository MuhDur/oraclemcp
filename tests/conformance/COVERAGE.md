...
| DASHBOARD-B8-010 | MUST | Dashboard B.8 | Source-replaceable governed DDL captures prior source into content-addressed service snapshots when visible, source-history lists omit source text, and revert drafts a reviewed DDL Change Proposal instead of directly applying DDL. |
