...
.. code-block:: json

  {
    ...
    "release_targets": [{"repository": "server", "version": "0.10.0",
                         "assertion": "patch"}],
    "tasks": [{
      "slug": "g1", "repository": "server", "tracker": "server",
      "title": "...", "type": "task", "priority": 1, "tier": "tier-1",
      "labels": ["train-0100", "plan:example:g1"],
      "tracking_label": "train-0100", "plan": {"section": "§27", "label": "plan:example:g1"},
...
def _selftest_manifest(base: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "release_targets": [
            {"repository": "server", "version": "0.10.0", "assertion": "patch"},
