...
| Rollback runbook dry-run | `oraclemcp-epic-060-f4xo.12.7` | `docs/release-checklist.md`, `scripts/e2e/release_rollback_dry_run.sh`, `crates/oraclemcp/tests/e2e_harness.rs::rollback_runbook_dry_run_covers_release_surfaces` | PASS |
