...
| Ladder governed-refusal error-classes (forbidden-statement + smuggled-DML never served as a read), per lane | `oraclemcp-v4d9` | `scripts/e2e/oracle_ladder_session.py::read_only_forbidden_statement_refused`, `::read_only_smuggled_dml_not_served_as_read`, `::query_governed_refusal` | PENDING-LIVE |
