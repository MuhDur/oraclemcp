...
docker run -i --rm \
  ...
  ghcr.io/muhdur/oraclemcp:0.7.2
```
...
```sh
docker run -i --rm ghcr.io/muhdur/oraclemcp:0.7.2 info       # version, tools, transports
docker run -i --rm ghcr.io/muhdur/oraclemcp:0.7.2 --json doctor
```
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: oraclemcp
          image: ghcr.io/muhdur/oraclemcp:0.7.2
          args:
            - serve
            - --listen
            - 0.0.0.0:7070
