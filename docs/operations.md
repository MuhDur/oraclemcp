...
docker run -i --rm \
  ...
  ghcr.io/muhdur/oraclemcp:0.8.0
```
...
```sh
docker run -i --rm ghcr.io/muhdur/oraclemcp:0.8.0 info       # version, tools, transports
docker run -i --rm ghcr.io/muhdur/oraclemcp:0.8.0 --json doctor
```
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: oraclemcp
          image: ghcr.io/muhdur/oraclemcp:0.8.0
          args:
            - serve
            - --listen
            - 0.0.0.0:7070
